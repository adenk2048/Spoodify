...
font = pygame.font.Font("CascadiaCodeNF-SemiBold.otf", 20)
...
pause_time = 0
last_play = time.time()
loop_dict = {False:(80,200,120),True:(40,160,80)}
...
lengths = {song : MP3(song+".mp3").info.length for song in t}
...
while running:
    ...
    if not pygame.mixer.music.get_busy() and not pause:
        ...
        song_length = lengths[t[index]]#MP3(t[index]+'.mp3').info.length
